...
<body>
    ...
    <table style="width: 700px; height: 420px">
        ...
        <tr>
            ...
            <td style="width: 170px">
                <asp:DropDownList ID="DropDownListFacultate" runat="server">
                    ...
                    <asp:ListItem Value="0">Matematica si Informatica</asp:ListItem>
                    <asp:ListItem Value="1">Litere</asp:ListItem>
                    <asp:ListItem Value="2">Biologie</asp:ListItem>
                </asp:DropDownList></td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TextBoxVarsta"
                    Display="Dynamic" ErrorMessage="Dati varsta in intervalul 0-120" MaximumValue="120"
        ...
        <tr>
            ...
            <td style="width: 170px">
                <asp:Button ID="Button1" runat="server" Text="Trimite" OnClick="Button1_Click" /></td>
            <td>
                &nbsp;</td>
        </tr> 
        <tr>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="search string is empty" ControlToValidate="SearchTextBox" ValidationGroup="VGSearch"></asp:RequiredFieldValidator>
    </form>
</body>
</html>
