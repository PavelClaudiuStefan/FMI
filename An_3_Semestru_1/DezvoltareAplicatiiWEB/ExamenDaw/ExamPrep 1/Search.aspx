...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="labelSearchedFor" runat="server" Text="You searched for: "></asp:Label>
    <br />
    <asp:Label ID="labelSearchTerm1" runat="server" Text="Label"></asp:Label>
    <br />
    <asp:Label ID="labelSearchTerm2" runat="server" Text="Label"></asp:Label>

    <asp:SqlDataSource ID="SmartphoneSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"/>
